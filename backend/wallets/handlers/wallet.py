...
from wallets.serializers.wallet import WalletCreateSerializer, WalletListParametersSerializer
...
class WalletDetailView(APIView):
    ...
    def get_wallet_and_check_permissions(self, request, pk):
        ...
        wallet: WalletDetailsResponse = WalletController.wallet_details(controller_request)
    ...
    def patch(self, request: Request, pk: int) -> Response:
        ...
        if serializer.is_valid():
            ...
            response: UpdateWalletResponse = WalletController.update_wallet(controller_request)
    ...
    def delete(self, request: Request, pk: int) -> Response:
        ...
        response: DeleteWalletResponse = WalletController.delete_wallet(controller_request)

        return Response(
            data= {'id': pk, 'message': 'Wallet deleted.'},
            status=response.status
        )
