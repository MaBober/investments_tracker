...
def test_transaction_update(test_user, test_wallets, test_accounts, test_currencies, test_market_shares):
    """
    Test the update of a Transaction model instance.
    """
    ...
    assert exception_info.value.message_dict['transaction_update_unavailable'][0] == 'Updating transactions will be added soon.'